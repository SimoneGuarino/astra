...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct MeetingRecallRequest {
    pub query: String,
    #[serde(default = "default_session_memory_limit")]
    pub limit: usize,
    #[serde(default)]
...
#[derive(Debug, Clone, Copy, Serialize, Deserialize, PartialEq, Eq, Default)]
#[serde(rename_all = "snake_case")]
pub enum MeetingRecallIntent {
    #[default]
    General,
    Decision,
    ActionItems,
    ScreenContextForTopic,
    ScreenContext,
    Technical,
}
...
#[derive(Debug, Clone, Copy, Serialize, Deserialize, PartialEq, Eq, Default)]
#[serde(rename_all = "snake_case")]
pub enum MeetingRecallEvidenceRelation {
    #[default]
    DirectMatch,
    LinkedScreenContext,
    TemporalScreenContext,
    SameSessionScreenContext,
}

#[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
pub struct MeetingRecallEvidence {
    pub session_id: String,
    pub session_title: String,
    pub matched_kind: String,
    pub title: String,
    pub snippet: String,
    #[serde(default)]
    pub relation: MeetingRecallEvidenceRelation,
    #[serde(default)]
    pub evidence_segment_ids: Vec<String>,
    #[serde(default)]
    pub screen_context_ids: Vec<String>,
    #[serde(default)]
    pub timestamp_ms: Option<u64>,
    pub score: f32,
}
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct MeetingRecallDiagnostics {
    ...
    #[serde(default)]
    pub llm_endpoint: Option<String>,
    pub query_char_count: usize,
    pub query_language: MeetingLanguage,
    #[serde(default)]
    pub recall_intent: MeetingRecallIntent,
    pub searched_session_count: usize,
    pub matched_session_count: usize,
    ...
    pub output_json_parse_failed: bool,
    pub invalid_evidence_indexes: usize,
    #[serde(default)]
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct MeetingRecallResponse {
    pub answer: String,
    pub status: MeetingRecallStatus,
    #[serde(default)]
    pub evidence: Vec<MeetingRecallEvidence>,
    #[serde(default)]
    pub sessions: Vec<MeetingSessionListItem>,
    pub diagnostics: MeetingRecallDiagnostics,
}
